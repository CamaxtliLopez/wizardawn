...
function dressMeup($sex,$race,$class) ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	$personality = mt_rand(1,8);
		if ($class == "Paladin"){$trait3 = ['modest', 'friendly', 'well-spoken', 'diplomatic', 'courteous', 'friendly', 'well-spoken', 'courteous'];}
		else if ($personality < 6){$trait3 = ['modest', 'egoist and arrogant', 'friendly', 'aloof', 'hostile', 'well-spoken', 'diplomatic', 'abrasive'];}
		else if ($personality < 8){$trait3 = ['forceful', 'overbearing', 'friendly', 'blustering', 'antagonistic', 'rude', 'rash', 'diplomatic'];}
		else {$trait3 = ['retiring', 'reserved', 'friendly', 'aloof', 'hostile', 'rude', 'courteous', 'solitary and secretive'];}

	//////////////////////////////////////////////////////////////////////////////////// TRAITS
	if ($class == "Paladin")
	{
		$trait1 = ['clean', 'immaculate', 'average'];
		$trait2 = ['optimistic', 'pessimistic', 'helpful and kindly', 'attentive', 'curious and inquisitive', 'trusting', 'suspicious and cautious', 'precise and exacting', 'perceptive', 'opinionated'];
		$trait4 = ['cheerful', 'compassionate', 'humble', 'proud', 'even tempered', 'easy going'];
		$trait5 = ['soft-hearted', 'forgiving', 'honorable', 'truthful'];
		$trait6 = ['virtuous', 'normal', 'normal'];
	...
	{
		$trait1 = ['dirty', 'clean', 'unkempt', 'immaculate', 'rough', 'ragged', 'dandyish', 'foppish', 'average', 'imposing'];
		$trait2 = ['optimistic', 'pessimistic', 'hedonistic', 'altruistic', 'helpful and kindly', 'careless', 'capricious and mischievous', 'attentive', 'curious and inquisitive', 'moody', 'trusting', 'suspicious and cautious', 'precise and exacting', 'perceptive', 'opinionated', 'violent and warlike', 'studious', 'foul and barbaric', 'cruel and callous', 'a prankster', 'servile and obsequious', 'fanatical and obsessive', 'malevolent', 'loquacious'];
		$trait4 = ['cheerful', 'morose', 'compassionate', 'insensitive', 'humble', 'proud', 'even tempered', 'hot tempered', 'easy going', 'harsh'];
		$trait5 = ['soft-hearted', 'forgiving', 'hard-hearted', 'unforgiving', 'jealous', 'vengeful', 'scrupulous', 'honorable', 'truthful', 'deceitful'];
		$trait6 = ['aesthetic', 'virtuous', 'normal', 'normal', 'lusty', 'lusty', 'lustful', 'immoral', 'amoral', 'aesthetic', 'virtuous', 'normal', 'normal', 'lusty', 'lusty', 'lustful', 'immoral', 'amoral', 'perverted', 'sadistic', 'depraved'];
		...
		//////////////////////////////////////////////////////////////////////////////////// INTERESTS
		$interests = ['none', 'none', 'none', 'religion', 'legends', 'history', 'nature', 'exotic animals', 'hunting', 'fishing', 'handicrafts', 'politics', 'wines and spirits', 'cooking', 'gambling', 'herbalism', 'collector', 'collector', 'collector', 'collector'];
		$interest = $interests[mt_rand(0,19)];
		 if ($birth == "child"){$interest = "none";}
		  if ($interest != "none")
		  {
			...
			{
				$collects = ['plants and flowers', 'knives and daggers', 'swords', 'weapons', 'shields and armor', 'books and scrolls', 'minerals and gems', 'ornaments and jewelry', 'coins and tokens', 'trophies and skins', 'porcelain, china and crystal', 'artwork'];
...
//////////////////////////////////////////////////////////////////////////////////// AGE
$ages = ['young', 'young', 'young', 'mature', 'mature', 'mature', 'mature', 'middle-aged', 'old'];
	if ($age != "child"){$age = $ages[mt_rand(0,8)];}

//////////////////////////////////////////////////////////////////////////////////// HEALTH
	$hitdice = ['1', '1', '1', '1', '1', '2', '2', '2', '3', '4'];
	$hd = $hitdice[mt_rand(0,9)];
	$hp = $hd * mt_rand($might1, max((int)($might1), (int)(($might2*$might1))));
	if ($age == "child"){$hd = 1; $hp = ceil($hd * mt_rand($might1, max((int)($might1), (int)(($might2*$might1))))/2);}

//////////////////////////////////////////////////////////////////////////////////// DAMAGE
$damage = ['3', '3', '3', '3', '4', '4', '4', '6'];
...
{
	$armors = ['9', '9', '9', '9', '9', '8', '8', '7'];
	$armor = $armors[mt_rand(0,7)];
	if ($birth == "child"){$armor = 9;}
}
else
{
	$armors = ['10', '10', '10', '10', '10', '9', '9', '8'];
	$armor = $armors[mt_rand(0,7)];
	if ($birth == "child"){$armor = 10;}
}

//////////////////////////////////////////////////////////////////////////////////// INTELLECT
$iq = ['Low', 'Average', 'Average', 'Average', 'Average', 'Very', 'Very', 'High'];

//////////////////////////////////////////////////////////////////////////////////// MORALITY
if ($game != "Fantasy"){$alignment = ['Lawful','Lawful','Lawful','Neutral','Neutral','Neutral','Neutral','Neutral','Neutral', 'Chaotic'];}
else {$alignment = ['Good','Good','Good','Fair','Fair','Fair','Fair','Fair','Fair', 'Evil'];}
...
//////////////////////////////////////////////////////////////////////////////////// PERSONALITY
$personality = mt_rand(1,8);
	if ($personality < 6){$trait3 = ['modest', 'egoist and arrogant', 'friendly', 'aloof', 'hostile', 'well-spoken', 'diplomatic', 'abrasive'];}
	else if ($personality < 8){$trait3 = ['forceful', 'overbearing', 'friendly', 'blustering', 'antagonistic', 'rude', 'rash', 'diplomatic'];}
	else {$trait3 = ['retiring', 'reserved', 'friendly', 'aloof', 'hostile', 'rude', 'courteous', 'solitary and secretive'];}
...
$haircolor = ['black', 'brown', 'red', 'auburn', 'gray', 'white', 'blonde'];
	$hcolor = $haircolor[mt_rand(0,6)];
	if ($birth == "child"){$haircolor = ['black', 'brown', 'red', 'auburn', 'blonde']; $hcolor = $haircolor[mt_rand(0,4)];}
...
//////////////////////////////////////////////////////////////////////////////////// EQUIPMENT
	...
	$scolor = ['gold', 'silver', 'bronze', 'copper', 'platinum', 'metal', 'iron'];
		...
		$feet = ['boots', 'fur boots', 'sandals', 'thigh boots', 'shoes'];
			$w_shoe = ", " . $bcolor[mt_rand(0,6)] . " " . $feet[mt_rand(0,4)];

		$pants = ['kilt', 'long pants', 'short pants', 'long pants', 'short pants', 'long pants', 'short pants', 'skirt'];
			if ($sex == "Female"){$pantc = 7;} else {$pantc = 6;}
			$w_legs = ", " . $hcolor[mt_rand(0,25)] . " " . $pants[mt_rand(0, max((int)(0), (int)($pantc)))];

		$head = ['feathered hat', 'floppy hat', 'skullcap', 'tricorne hat', 'wide-brim hat', 'cap', 'bandana', 'bonnet'];
			if ($sex == "Female"){$hatc = 7;} else {$hatc = 6;}
			if (mt_rand(1,100) > 60){$w_head = ", " . $hcolor[mt_rand(0,25)] . " " . $head[mt_rand(0, max((int)(0), (int)($hatc)))];} else {$w_head = "";}
		...
		$shirt = ['fancy shirt', 'formal shirt', 'doublet', 'tunic', 'shirt', 'plain dress', 'gilded dress', 'fancy dress'];
			if ($sex == "Female"){$shirtc = 7;} else {$shirtc = 4;}
			$dresses = mt_rand(0, max((int)(0), (int)($shirtc))); if ($dresses > 4){$w_legs = "";}
...
{
  $hut2 = ['Badger', 'Basilisk', 'Bear', 'Boar', 'Bufallo', 'Bugbear', 'Bull', 'Centaur', 'Chimera', 'Cloud Giant', 'Crocodile', 'Cyclops', 'Demon', 'Devil', 'Dog', 'Dragon', 'Drake', 'Dryad', 'Dwarf', 'Elephant', 'Elf', 'Ettin', 'Fire Giant', 'Fish', 'Frog', 'Frost Giant', 'Gargoyle', 'Genie', 'Gnoll', 'Gnome', 'Goblin', 'Gorgon', 'Griffin', 'Hag', 'Hobbit', 'Harpy', 'Hell Hound', 'Hill Giant', 'Hippogriff', 'Hippopotamus', 'Hobbit', 'Hobgoblin', 'Horse', 'Hydra', 'Imp', 'Jackal', 'Kobold', 'Kraken', 'Leprechaun', 'Lion', 'Lizard', 'Manticore', 'Mephit', 'Minotaur', 'Mule', 'Naga', 'Nixie', 'Nymph', 'Bullywug', 'Ogre', 'Orc', 'Owlbear', 'Pegasus', 'Phoenix', 'Pixie', 'Purple Worm', 'Quickling', 'Rust Monster', 'Scorpion', 'Serpent', 'Reaper', 'Snake', 'Sphinx', 'Spider', 'Sprite', 'Stone Giant', 'Storm Giant', 'Succubus', 'Tiger', 'Titan', 'Toad', 'Treant', 'Triton', 'Troglodyte', 'Troll', 'Turtle', 'Unicorn', 'Walrus', 'Weasel', 'Werewolf', 'Whale', 'Wisp', 'Wolf', 'Wolverine', 'Wyrm', 'Wyvern', 'Xorn', 'Yeti'];
  $hut2 = $hut2[mt_rand(0,97)];

   if (mt_rand(1,100) > 70)
   {
	$hut2 = ['Adventurer', 'Axe', 'Bandit', 'Barbarian', 'Bard', 'Baron', 'Berserker', 'Claw', 'Club', 'Coin', 'Conjurer', 'Dagger', 'Dancer', 'Druid', 'Dutchess', 'Eye', 'Fighter', 'Hammer', 'Helm', 'Hermit', 'Hunter', 'Idol', 'Jester', 'King', 'Knife', 'Knight', 'Mace', 'Mage', 'Magician', 'Monk', 'Nail', 'Pirate', 'Priest', 'Prince', 'Princess', 'Prophet', 'Queen', 'Ranger', 'Scout', 'Shield', 'Singer', 'Sorcerer', 'Sword', 'Thief', 'Tracker', 'Tree', 'Warlock', 'Warrior', 'Whip', 'Witch', 'Wizard', 'Staff'];
	$hut2 = $hut2[mt_rand(0,51)];
   }

  $hut3 = ['Steel', 'Wooden', 'Iron', 'Bronze', 'Silver', 'Gold', 'Copper', 'Stone', 'Platinum', 'Wild', 'Sleeping', 'Lone', 'Savage', 'Scarlett', 'Twin', 'Old', 'Dark', 'Needy', 'Wealthy', 'Common', 'Cursed', 'Elegant', 'Great', 'Smiling', 'Keen', 'Needy', 'Quiet', 'Jealous', 'Cheap', 'Fiery', 'Hidden', 'Mighty', 'New'];
...
if ($type == 5) // BOWYER ///////////////////////////////////////////////
{
	$hut1 = ['Bows', 'Bowyer Shoppe', 'Fletcher Shoppe', 'Bow Shoppe', 'Archery Shoppe', 'Bow Crafters', 'Archery Supplies', 'Archer Store', 'Bow & Arrow Dealer'];
	$hut1 = $hut1[mt_rand(0,8)];

	if (mt_rand(1,100) > 30)
	{
		$hut2 = ['Shot', 'Arrow', 'Bolt', 'Target', 'Trueshot', 'Aim', 'Feather', 'Tipped'];
...
{
	$hut1 = ['Alehouse', 'Tavern', 'Saloon', 'Bar', 'Stein', 'Keg', 'Barrel', 'Flagon', 'Mug'];
	$hut1 = $hut1[mt_rand(0,8)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Drunken', 'Leaping', 'Sleepy', 'Crazy', 'Angry', 'Dancing', 'Bloody', 'Running', 'Screaming', 'Growling', 'Mighty', 'Laughing', 'Broken', 'Wild'];
...
{
	$hut1 = ['Inn', 'Inn', 'Inn', 'Inn', 'Inn', 'Hostel', 'Lodge', 'Boarding House', 'Cabin'];
	$hut1 = $hut1[mt_rand(0,8)];
	$hut1 = $hut1 . " </b><i>(" . mt_rand(2,7) . "sp per night)</i><b>";

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Weary', 'Restful', 'Sleepy', 'Cozy', 'Tired', 'Restless', 'Dreamy', 'Silent', 'Calm', 'Faint', 'Yawning', 'Dead', 'Tuckered', 'Dozing', 'Tranquil'];
...
{
	$hut1 = ['Tailor', 'Tailor Shoppe', 'Sewing Shoppe', 'Fine Cloth', 'Clothing Shoppe', 'Dress Shoppe', 'Dresses'];
	$hut1 = $hut1[mt_rand(0,6)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Wooly', 'Knitted', 'Needled', 'Stitched', 'Hooded', 'Dressed', 'Cloaked', 'Robed'];
...
{
	$hut1 = ['Herbalist', 'Herb Shoppe', 'Alchemist', 'Potion Shoppe', 'Elixirs', 'Alchemy Shoppe', 'Cauldron'];
	$hut1 = $hut1[mt_rand(0,6)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Brewed', 'Boiled', 'Stirred', 'Fermented', 'Concocted', 'Brewed'];
...
{
	$hut1 = ['Anvil', 'Smithy', 'Forge', 'Hammer', 'Blacksmith', 'Blacksmith', 'Smithy', 'Arms & Armor', 'Weapons', 'Shields'];
	$hut1 = $hut1[mt_rand(0,9)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Melted', 'Steel', 'Iron', 'Dented', 'Armored', 'Metal', 'Smelted', 'Heated'];
		$hut3 = $hut3[mt_rand(0,7)];
	}
...
{
	$hut1 = ['Stables', 'Pets', 'Animals', 'Stables', 'Barn Yard', 'Animal Trainer', 'Stables'];
	$hut1 = $hut1[mt_rand(0,6)];

	$hut2 = ['Beast', 'Bear', 'Boar', 'Horse', 'Steed', 'Rider', 'Mule', 'Pony'];
	$hut2 = $hut2[mt_rand(0,7)];
...
{
	$hut1 = ['Carpenter', 'Wood Shoppe', 'Carvings', 'Woodworking', 'Carpentry Shoppe', 'Wooden Crafts'];
	$hut1 = $hut1[mt_rand(0,5)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Oak', 'Cedar', 'Pine', 'Ash', 'Maple', 'Birch', 'Mahogany', 'Spruce'];
		$hut3 = $hut3[mt_rand(0,7)];
	}
...
{
	$hut1 = ['Leatherworking', 'Tanning Shoppe', 'Leather Market', 'Stitched Hide', 'Rawhide', 'Thick Skins'];
	$hut1 = $hut1[mt_rand(0,5)];
...
{
	$hut1 = ['Baked Goods', 'Bakery', 'Bake Shoppe', 'Foods', 'Food Market'];
	$hut1 = $hut1[mt_rand(0,4)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Delightful', 'Tasty', 'Homemade', 'Oven Fresh', 'Toasty', 'Yummy', 'Savory', 'Sweet', 'Hungry', 'Starving'];
...
{
	$hut1 = ['Pawn', 'Pawn Shoppe', 'Provisioner', 'Supplies', 'Equipment', 'Goods'];
	$hut1 = $hut1[mt_rand(0,5)];

	if ((mt_rand(1,100) > 30) && ($gamma != 2))
	{
		$hut3 = ['Adventurous', 'Impish', 'Treasured', 'Royal', 'Traveling', 'Cheap', 'Golden', 'Grand'];
		$hut3 = $hut3[mt_rand(0,7)];
	}
...
{
	$hut1 = ['Books', 'Writings', 'Library', 'Atheneum', 'Scrolls', 'Book Shoppe'];
	$hut1 = $hut1[mt_rand(0,5)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Cryptic', 'Ancient', 'Runic', 'Mysterious', 'Wizardly', 'Thinking', 'Royal', 'Scribbled'];
		$hut3 = $hut3[mt_rand(0,7)];
	}
...
{
	$hut2 = ['Temple', 'Church', 'Abbey', 'Shrine', 'Sanctuary', 'Temple', 'Church', 'House'];
	$hut2 = $hut2[mt_rand(0,7)];

	$hut3 = ['Holy', 'Sacred', 'Virtuous', 'Devoted', 'Devout', 'Divine', 'Faithful', 'Glorious', 'Righteous', 'Saintly', 'Sanctified'];
	$hut3 = $hut3[mt_rand(0,10)];

	$hut1 = ['the Gods', 'the Creator', 'the Father', 'the Mother', 'the Almighty', 'the Lord', 'the Goddess', 'the Maker', 'Devotion', 'Praise', 'Worship'];
...
{
	$hut1 = ['Bank', 'Bank', 'Bank', 'Vault', 'Treasury'];
	$hut1 = $hut1[mt_rand(0,4)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Wealthy', 'Guarded', 'Safe', 'Shiny', 'Rich', 'Hoarding', 'Treasured', 'Noble', 'Royal', 'Locked', 'Chained', 'Watched', 'Bolted', 'Sealed', 'Keyed'];
		$hut3 = $hut3[mt_rand(0,14)];
	}
}
else if ($type == 14) // MUSIC ///////////////////////////////////////////////
{
	$hut1 = ['Music Shoppe', 'Instruments', 'Instrument Crafters', 'Drummer', 'Lute Makers', 'Stringed Instruments'];
	$hut1 = $hut1[mt_rand(0,5)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Singing', 'Humming', 'Harmonic', 'Lyrical', 'Choral', 'Melodic', 'Harmonious', 'Tuneful'];
		$hut3 = $hut3[mt_rand(0,7)];
	}
...
{
	$hut1 = ['Jeweler', 'Gem Shoppe', 'Jewelry Shoppe', 'Fine Stones', 'Precious Gems', 'Diamonds', 'Emeralds', 'Rubies', 'Pearls'];
	$hut1 = $hut1[mt_rand(0,8)];

	if (mt_rand(1,100) > 30)
	{
		$hut3 = ['Shiny', 'Sparkly', 'Twinkling', 'Gleaming', 'Shimmering', 'Glinting', 'Rare', 'Priceless'];
		$hut3 = $hut3[mt_rand(0,7)];
	}
}
else if ($type == 17) // GUARD HOUSE ///////////////////////////////////////////////
{
	$hut1 = ['Guardhouse', 'Barracks', 'Sleeping Quarters', 'Sentry Post', 'Guardhouse', 'Barracks'];
	$hut1 = $hut1[mt_rand(0,5)];

	$hut3 = ['Patrolling', 'Watchful', 'Guarding', 'Defending', 'Protecting'];
	$hut3 = $hut3[mt_rand(0,4)];
}
else if ($type > 17) // GUILDS /////////////////////////////////////////////////
{
	$hut1 = ['Guild', 'Guild', 'Lodge', 'League', 'Order', 'Society', 'Clan', 'Fraternity', 'Circle', 'Ring', 'Union'];
	$hut1 = $hut1[mt_rand(0,10)];

	if ($type == 18){$hut3 = ['Fighters', 'Warriors', 'Champions', 'Soldiers', 'Gladiators', 'Defenders', 'Mercenaries', 'Legionnaires'];}
	else if ($type == 19){$hut3 = ['Wizards', 'Mages', 'Sorcerers', 'Magicians', 'Magic-Users', 'Occultists', 'Enchanters', 'Conjurers'];}
	else if ($type == 20){$hut3 = ['Thieves', 'Bandits', 'Burglars', 'Sneaks', 'Prowlers', 'Highwaymen', 'Muggers', 'Swindlers'];}
	else if ($type == 21){$hut3 = ['Rangers', 'Hunters', 'Woodsmen', 'Travelers', 'Adventurers', 'Rangers', 'Hunters', 'Woodsmen'];}
	else if ($type == 22){$hut3 = ['Assassins', 'Murderers', 'Killers', 'Slayers', 'Executioners', 'Cut-Throats', 'Assassins', 'Cut-Throats'];}
	else {$hut3 = ['Artists', 'Bards', 'Minstrels', 'Actors', 'Musicians', 'Poets', 'Singers', 'Entertainers'];}

	$hut3 = $hut3[mt_rand(0,7)];

	$hut2 = ['Dark', '', 'Hidden', 'Grand', 'Glorious', 'Mysterious', 'Secret', 'Great', 'Marvelous', 'Amazing', 'Mystical', 'Legendary', 'Eternal', 'Exalted', 'Ultimate', 'Royal', 'Almighty', 'Supreme', 'Dominant', 'Fallen', 'Mighty', 'Unknown', 'Forgotten'];
			...
			while ($inventory > 0) :
					...
					if ($columns > 0){$tablc = 1;}
						if ($tablc == 1){$tabx = $tabx . "<tr>";}
							...
							if (mt_rand(1,2) == 1){$tabx = $tabx . "<td NOWRAP><font size='2'>" . ucwords((string) gemCreator(mt_rand(10,100))) . "</font></td>";}
							else {$tabx = $tabx . "<td NOWRAP><font size='2'>" . ucwords((string) jewelCreator(mt_rand(10,100))) . "</font></td>";}
