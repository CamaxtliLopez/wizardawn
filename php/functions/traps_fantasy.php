...
function trapMaker($level,$type,$game,$extra,$undead)
{
	...
	if (($game == "Tunnels & Trolls 5th Edition") || ($game == "Tunnels & Trolls 7th Edition") || ($game == "Tunnels & Trolls Deluxe")) ////////////////////////////////////////////////////////////////
	{
		...
		switch (mt_rand(0, max((int)(0), (int)($trap_max))))
		{
			case 0:	$trap = ucfirst((string) fogColor()) . " acidic gases " . $t_where . " causing 1d6+" . $level . " damage to " . $t_who . ".";	break;
			case 1:	$trap = ucfirst((string) fogColor()) . " poisonous gases " . $t_where . " where " . $t_who . " must make a " . TTSaves($level,$game) . " vs. " . abilityTranslate($game,'STR') . " or " . abilityTranslate($game,'CON') . " or " . $death0 . ".";	break;
			...
			case 34:$trap = ucfirst((string) fogColor()) . " gases " . $t_where . " causing memory loss to " . $t_who . " for about " . mt_rand(2,4) . " hours...where " . abilityTranslate($game,'WIZ') . " is also reduced to zero during that time.";	break;
			...
			case 36:$trap = ucfirst((string) fogColor()) . " gases " . $t_where . " that cause instant unconsciousness to " . $t_who . " for about " . mt_rand(4,10) . " hours...unless they can make a " . TTSaves($level,$game) . " vs. " . abilityTranslate($game,'STR') . " or " . abilityTranslate($game,'CON') . ".";	break;
			case 37:$trap = ucfirst((string) fogColor()) . " gases fill the area. Any flame will ignite it causing all " . $t_pit . " to make a " . TTSaves($level,$game) . " vs. " . abilityTranslate($game,'STR') . " or " . abilityTranslate($game,'CON') . " from the explosion or " . $death4 . "."; break;
			...
			case 44:
				...
				break;
			case 45:$trap = ucfirst((string) fogColor()) . " gases " . $t_where . " causing laughter to " . $t_who . " for about " . mt_rand(2,6) . " turns (unless they can make a " . TTSaves($level,$game) . " vs. " . abilityTranslate($game,'INT') . ")...where wandering encounter checks are made each turn the laughing continues.";	break;
	...
	else ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
		...
		switch (mt_rand(0, max((int)(0), (int)($trap_max))))
		{
			case 0:	$trap = ucfirst((string) fogColor()) . " acidic gases " . $t_where . " causing 1d8+" . $level . " damage to " . $t_who . ".";
				if ($game == "Swords & Six-Siders"){ $trap = ucfirst((string) fogColor()) . " acidic gases " . $t_where . " causing 1d6+" . $level . " damage to " . $t_who . "."; }
				break;
			case 1:	$trap = ucfirst((string) fogColor()) . " poisonous gases " . $t_where . " where " . $t_who . " must save for poison or " . $death0 . ".";	break;
			case 2:	$trap = "A pit opens up " . $t_pit . " that is " . $pit_depth . " feet deep. Anyone who falls in will take " . $pit_damage . " damage.";	break;
			case 3:	$trap = "A pit opens up " . $t_pit . " that is " . $pit_depth . " feet deep and layered in spikes. Anyone who falls in will take " . $pit_damage . "x" . mt_rand(2,4) . " damage.";	break;
			...
			case 32:$trap = "The ceiling becomes highly magnetized, causing all metal objects to fly up to the ceiling...carrying metal armor wearing adventurers up as well.";	break;
			case 33:$trap = "A wall closes the exits to the area. The room then begins to " . $death5 . " in temperature for about " . mt_rand(2,6) . "0 minutes...where no one can survive the extreme " . $death6 . ".";	break;
			case 34:$trap = ucfirst((string) fogColor()) . " gases " . $t_where . " causing memory loss to " . $t_who . " for about " . mt_rand(2,4) . " hours...where memorized spells are also lost.";	break;
			...
			case 36:$trap = ucfirst((string) fogColor()) . " gases " . $t_where . " that cause instant unconsciousness to " . $t_who . " for about " . mt_rand(4,10) . " turns...unless they can save for paralysis.";	break;
			case 37:$trap = ucfirst((string) fogColor()) . " gases fill the area. Any flame will ignite it causing all " . $t_pit . " to save for breath from the explosion or " . $death4 . "."; break;
			case 38:$trap = "A pit opens up " . $t_pit . " that is " . $pit_depth . " feet deep (taking " . $pit_damage . " damage from the fall) and filled with some odd " . candleColor(0) . " mushrooms. Anyone who falls in will land on them, causing them to release " . fogColor() . " spores that cause " . $shrooms . ".";	break;
			...
			case 44:
				...
				break;
			case 45:$trap = ucfirst((string) fogColor()) . " gases " . $t_where . " causing laughter to " . $t_who . " for about " . mt_rand(2,6) . " turns (unless they can save for poison)...where wandering encounter checks are made each turn the laughing continues.";	break;
			case 46:$trap = "A wall closes the exits to the area. Sand then begins to fill the room from above.";	break;
			case 47:$trap = "A loud " . $noise . " is made coming " . $t_noise . " that will continue for " . mt_rand(2,6) . " turns unless deactivated prior. Wandering monsters checks are made each round during the noise and " . mt_rand(2,6) . " rounds after the noise stops.";	break;
			case 48:
				switch (mt_rand(0,3))
