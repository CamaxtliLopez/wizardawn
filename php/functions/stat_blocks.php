<?php
		$notes = "";	$note1 = "";	$note2 = "";	$note3 = "";	$monster_info = "";		$note_wep = "";		$note_owep = "";	$note_build = "";	$my_real_name = $ary['name'];
			...
			if ($x_crossover == "Goblinoid")
			{
				if ($ary['weapons'] != "")
				{
					if ($ary['creator'] == "MF"){ $notes = " | <b>Weapon</b>: " . PAgetWeapon((num($ary['weapons'])),$x_game) . " "; }
			...
			else if (($x_game == "Millenniums & Mutations 5th Edition") || ($x_game == "Millenniums & Mutations 7th Edition"))
			{
				if ($ary['weapons'] != "")
				{
					$note_wep = " | <b>Weapon</b>: " . PAgetWeapon((num($ary['weapons'])),$x_game) . " ";
					$note_wep = str_replace(" ", "&nbsp;", $note_wep);

					$note_owep = " | <b>WEP</b>: " . PAgetWeapon((num($ary['weapons'])),$x_game) . " ";
			...
			if ($x_game == "OSRIC")
			{
				$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [FREQ: " . $ary['freq'] . " | ENC: " . $ary['enc'] . " | SIZE: " . $ary['size'] . " | MOVE: " . $ary['move'] . " | AC: " . $ary['ac'] . " | HD: " . $ary['hd'] . " | ATK: " . $ary['atk'] . " | DMG: " . $ary['dmg'] . " | MR: " . $ary['mr'] . " | LAIR: " . $ary['lair'] . " | INT: " . $ary['iq'] . " | AL: " . $ary['al'] . " | XP: " . $ary['xp'] . " | BOOK: " . $ary['creator'] . $notes . "&nbsp;]";
			}
			else if ($x_game == "AD&D")
			{
			...
			{
				$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [<b>ENC:</b>&nbsp;" . $ary['enc'] . "; <b>AL:</b>&nbsp;" . $ary['al'] . "; <b>MV:</b>&nbsp;" . $ary['move'] . "; <b>AC:</b>&nbsp;" . $ary['ac'] . "; <b>HD:</b>&nbsp;" . $ary['hd'] . "; <b>AT:</b>&nbsp;" . $ary['atk'] . "; <b>DMG:</b>&nbsp;" . $ary['dmg'] . "; <b>SV:</b>&nbsp;L" . $ary['spdef'] . "; <b>ML:</b>&nbsp;" . $ary['bravery'] . "; <b>IQ:</b>&nbsp;" . $ary['iq'] . "; <b>THAC0:</b>&nbsp;" . $ary['thaco'] . "; <b>TRS:</b>&nbsp;" . $ary['loot'] . $notes . " " . $note_owep . "&nbsp;]";
			}
			else if ($x_game == "Swords & Wizardry")
			{
				$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [LV:&nbsp;" . $ary['level'] . "&nbsp;| HD:&nbsp;" . $ary['hd'] . "&nbsp;| AC:&nbsp;" . $ary['ac'] . "&nbsp;| ATK:&nbsp;" . $ary['atk'] . "&nbsp;| SV:&nbsp;" . $ary['spdef'] . "&nbsp;| SPEC:&nbsp;" . $ary['spatk'] . "&nbsp;| MV:&nbsp;" . $ary['move'] . "&nbsp;| AL:&nbsp;" . $ary['al'] . "&nbsp;| XP:&nbsp;" . $ary['xp'] . "&nbsp;| TOHIT:&nbsp;" . $ary['thaco'] . $notes . "&nbsp;]";
			}
			else if ($x_game == "Swords & Six-Siders")
			{
				if ( $ary['thaco'] < 1 ){ $svsx = $ary['thaco']; } else { $svsx = "+" . $ary['thaco']; }
				$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [LVL:&nbsp;" . $ary['al'] . "&nbsp;| AC:&nbsp;" . $ary['ac'] . "&nbsp;| DR:&nbsp;" . $ary['atk'] . "&nbsp;| TOHIT:&nbsp;" . $svsx . "&nbsp;| DMG:&nbsp;" . $ary['dmg'] . "&nbsp;| SV:&nbsp;" . $svsx . "&nbsp;| TYPE:&nbsp;" . $ary['type'] . "&nbsp;| LANG:&nbsp;" . $ary['spdef'] . $notes . "&nbsp;]";
			}
			else if ($x_game == "BD&D")
			{
				$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [AC:&nbsp;" . $ary['ac'] . "&nbsp;| HD:&nbsp;" . $ary['hd'] . "&nbsp;| MV:&nbsp;" . $ary['move'] . "&nbsp;| THAC0:&nbsp;" . $ary['thaco'] . "&nbsp;| ATK:&nbsp;" . $ary['atk'] . "&nbsp;| DMG:&nbsp;" . $ary['dmg'] . "&nbsp;| #APP:&nbsp;" . $ary['enc'] . "&nbsp;| SV:&nbsp;" . $ary['spdef'] . "&nbsp;| ML:&nbsp;" . $ary['bravery'] . "&nbsp;| TT:&nbsp;" . $ary['loot'] . "&nbsp;| AL:&nbsp;" . $ary['al'] . "&nbsp;| LV:&nbsp;" . $ary['difficulty'] . "&nbsp;| XP:&nbsp;" . $ary['xp'] . "&nbsp;| PAGE:&nbsp;" . $ary['lair'] . $notes . "&nbsp;]";
			}
			else if ($x_game == "BFRPG")
			{
				$ac = str_replace("‡", "&#8225;", $ary['ac']); $ac = str_replace("†", "&#8224;", $ac);
				$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [AC:&nbsp;" . $ac . "&nbsp;| HD:&nbsp;" . $ary['hd'] . "&nbsp;| ATK:&nbsp;" . $ary['atk'] . "&nbsp;| DMG:&nbsp;" . $ary['dmg'] . "&nbsp;| MV:&nbsp;" . $ary['move'] . "&nbsp;| #APP:&nbsp;" . $ary['enc'] . "&nbsp;| SV:&nbsp;" . $ary['spdef'] . "&nbsp;| ML:&nbsp;" . $ary['bravery'] . "&nbsp;| TRS:&nbsp;" . $ary['treasure'] . "&nbsp;| XP:&nbsp;" . $ary['xp'] . $notes . "&nbsp;]";
			...
			else if ($x_game == "Tunnels & Trolls 5th Edition")
			{
				...
				if ($x_supplement == "WW")
				{
					$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [LVL:&nbsp;" . $ary['difficulty'] . "&nbsp;|&nbsp;TYP:&nbsp;" . $ary['type'] . "&nbsp;|&nbsp;APP:&nbsp;" . $ary['enc'] . "&nbsp;|&nbsp;SZ:&nbsp;" . $ary['size'] . "&nbsp;|&nbsp;MV:&nbsp;" . $ary['move'] . "&nbsp;|&nbsp;MR:&nbsp;" . $my_mr_is . "&nbsp;<i>(Life)</i>&nbsp;|&nbsp;ATK:&nbsp;" . $mn_mod_attack . "&nbsp;|&nbsp;DMG:&nbsp;1d6+" . $mn_mod_damage . "&nbsp;|&nbsp;CR:&nbsp;" . $mn_mod_level . "&nbsp;<i>(" . $cr_monster . ")</i>&nbsp;|&nbsp;LANG:&nbsp;" . $ary['spdef'] . "&nbsp;|&nbsp;AP:&nbsp;" . $my_mr_is;
					if ($notes != ""){$monster_info = $monster_info . "&nbsp;|&nbsp;NOTE:&nbsp;" . $notes;}
				}
				else
				{
					if ($do_not_show_creatures != 1){$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [TYPE:&nbsp;" . $ary['type'] . "&nbsp;|&nbsp;MR:&nbsp;" . $my_mr_is . $notes . "&nbsp;|&nbsp;DICE:&nbsp;" . $my_dc_is . "&nbsp;|&nbsp;SIZE:&nbsp;" . $ary['size'] . "&nbsp;|&nbsp;MOVE:&nbsp;" . $ary['move'] . "&nbsp;|&nbsp;INT:&nbsp;" . $my_int_is . "&nbsp;|&nbsp;LANG:&nbsp;" . $ary['spdef'];}
					else {$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [TYPE:&nbsp;" . $ary['type'] . "&nbsp;|&nbsp;MR:&nbsp;" . $my_mr_is . $notes . "&nbsp;|&nbsp;DICE:&nbsp;" . $my_dc_is . "&nbsp;|&nbsp;#APP:&nbsp;" . $ary['enc'] . "&nbsp;|&nbsp;SIZE:&nbsp;" . $ary['size'] . "&nbsp;|&nbsp;MOVE:&nbsp;" . $ary['move'] . "&nbsp;|&nbsp;INT:&nbsp;" . $my_int_is . "&nbsp;|&nbsp;LANG:&nbsp;" . $ary['spdef'];}
				}
			}
			else if ($x_game == "Tunnels & Trolls 7th Edition" || $x_game == "Tunnels & Trolls Deluxe")
			{
				...
				if ($do_not_show_creatures != 1){$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [TYPE:&nbsp;" . $ary['type'] . "&nbsp;|&nbsp;MR:&nbsp;" . $my_mr_is . $notes . "&nbsp;" . $mr_is_level . "|&nbsp;DICE:&nbsp;" . $my_dc_is . "&nbsp;|&nbsp;SIZE:&nbsp;" . $ary['size'] . "&nbsp;|&nbsp;MOVE:&nbsp;" . $ary['move'] . "&nbsp;|&nbsp;WIZ:&nbsp;" . $my_wiz_is . "&nbsp;|&nbsp;LANG:&nbsp;" . $ary['spdef'];}
				else {$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [TYPE:&nbsp;" . $ary['type'] . "&nbsp;|&nbsp;MR:&nbsp;" . $my_mr_is . $notes . "&nbsp;" . $mr_is_level . "|&nbsp;DICE:&nbsp;" . $my_dc_is . "&nbsp;|&nbsp;#APP:&nbsp;" . $ary['enc'] . "&nbsp;|&nbsp;SIZE:&nbsp;" . $ary['size'] . "&nbsp;|&nbsp;MOVE:&nbsp;" . $ary['move'] . "&nbsp;|&nbsp;WIZ:&nbsp;" . $my_wiz_is . "&nbsp;|&nbsp;LANG:&nbsp;" . $ary['spdef'];}
			}
			else if (($x_game == "Millenniums & Mutations 5th Edition") || ($x_game == "Millenniums & Mutations 7th Edition"))
			{
				include("functions/monsters_tt.php");
				$monster_info = strtoupper((string) $my_real_name) . " [<b>MR:</b>&nbsp;" . $my_mr_is . $notes . "&nbsp;|&nbsp;<b>DICE:</b>&nbsp;" . $my_dc_is . "&nbsp;|&nbsp;<b>SIZE:</b>&nbsp;" . $ary['size'] . "&nbsp;|&nbsp;<b>MOVE:</b>&nbsp;" . $ary['move'] . "&nbsp;|&nbsp;<b>NOTES:</b>&nbsp;" . $description . "&nbsp;]";
			}
			else if ($x_game == "Broken Urthe")
			{
				if ($ary['type'] == "R"){ $monster_info = strtoupper((string) $ary['name']) . " [<b>Cond:</b> " . $ary['hd'] . " | <b>Prot:</b> " . $ary['ac'] . " | <b>Hit:</b> " . $ary['thaco'] . " | <b>Atks:</b> " . $ary['atk'] . " | <b>Dmg:</b> " . $ary['dmg'] . " | <b>Spd:</b> " . $ary['move'] . " | <b>Stg:</b> " . $ary['iq'] . " | <b>Size:</b> " . $ary['size'] . " | <b>Dfn:</b> " . $ary['lair'] . " | <b>Level:</b> " . $ary['level'] . " | <b>Salv:</b> " . $ary['salvage'] . "% | <b>Sft:</b> " . $ary['mr'] . "&nbsp;]" . $notes; }
				else { $monster_info = strtoupper((string) $my_real_name) . " [<b>Stam:</b> " . $ary['hd'] . " | <b>Prot:</b> " . $ary['ac'] . " | <b>Hit:</b> " . $ary['thaco'] . " | <b>Atks:</b> " . $ary['atk'] . " | <b>Dmg:</b> " . $ary['dmg'] . " " . $note_wep . " | <b>Spd:</b> " . $ary['move'] . " | <b>Stg:</b> " . $ary['iq'] . " | <b>Size:</b> " . $ary['size'] . " | <b>Dfn:</b> " . $ary['lair'] . " | <b>Level:</b> " . $ary['level'] . "&nbsp;]" . $notes; }
			}
			else if ($x_game == "Metamorphosis Alpha" || $x_game == "Gamma World")
			{
				if ($ary['level'] < 1){ $metalpha_level = 1; } else { $metalpha_level = $ary['level']; }
				$resistances = explode("/", (string) $ary['lair']);
				...
				if ($ary['type'] == "R"){ $monster_info = strtoupper((string) $ary['name']) . " [<b>MV:</b> " . retroNotes($ary['move'],$x_game,$ary['level']) . " | <b>SZ:</b> " . $ary['size'] . " | <b>AC:</b> " . $old_armor . " | <b>HD:</b> " . $metalpha_level . " | <b>ATK:</b> " . $ary['atk'] . " | <b>ATK&nbsp;CLASS:</b> " . $old_hit . " | <b>DMG:</b> " . $robot_hurt . " | <b>RAD&nbsp;RESIST:</b> " . $resist_radss . "&nbsp;]" . $notes; }
				else { $monster_info = strtoupper((string) $my_real_name) . " [<b>MV:</b> " . retroNotes($ary['move'],$x_game,$ary['level']) . " | <b>SZ:</b> " . $ary['size'] . " | <b>AC:</b> " . $old_armor . " | <b>HD:</b> " . $metalpha_level . " | <b>ATK:</b> " . $ary['atk'] . " " . $note_owep . " | <b>ATK&nbsp;CLASS:</b> " . $old_hit . " | <b>DMG:</b> " . $ary['dmg'] . " | <b>RAD&nbsp;RESIST:</b> " . $resist_radss . " | <b>MIND&nbsp;RESIST:</b> " . $resist_minds . " | <b>POISON&nbsp;RESIST:</b> " . $resist_toxns . "&nbsp;]" . $notes; }
			}
			else if ($x_crossover == "Goblinoid")
			{
				...
				$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [<b>ENC:</b> " . $ary['enc'] . " | <b>AL:</b> " . $aligner . " | <b>MV:</b> " . $ary['move'] . " | <b>AC:</b> " . $ary['ac'] . " | <b>HD:</b> " . $ary['hd'] . " | <b>ATK:</b> " . $ary['atk'] . " | <b>DMG:</b> " . $ary['dmg'] . " | <b>SV:</b> " . $ary['spdef'] . " | <b>ML:</b> " . $ary['bravery'] . " | <b>TRS:</b> " . $ary['loot'] . " | <b>LVL:</b> " . $ary['level'] . " | <b>THAC0:</b> " . $ary['thaco'] . " | <b>BOOK:</b> " . $ary['creator'] . $notes . " " . $note_owep . "&nbsp;]";
			}
			else if ($x_game == "Labyrinth Lord")
			{
				$monster_info = strtoupper((string) $ary['name']) . $extra_name . " [<b>ENC:</b> " . $ary['enc'] . " | <b>AL:</b> " . $ary['al'] . " | <b>MV:</b> " . $ary['move'] . " | <b>AC:</b> " . $ary['ac'] . " | <b>HD:</b> " . $ary['hd'] . " | <b>ATK:</b> " . $ary['atk'] . " | <b>DMG:</b> " . $ary['dmg'] . " | <b>SV:</b> " . $ary['spdef'] . " | <b>ML:</b> " . $ary['bravery'] . " | <b>TRS:</b> " . $ary['loot'] . " | <b>XP:</b> " . $ary['xp'] . " | <b>LVL:</b> " . $ary['level'] . " | <b>THAC0:</b> " . $ary['thaco'] . " | <b>BOOK:</b> " . $ary['creator'] . $notes . "&nbsp;]";
			}
