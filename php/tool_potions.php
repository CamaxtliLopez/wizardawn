...
{
	$bottom_notices = 18;
	$t_potions = ['Poison', 'Potion of Flying', 'Potion of Gaseous Form', 'Potion of Giant Strength', 'Potion of Growth', 'Potion of Healing', 'Potion of Invisibility', 'Potion of Levitation', 'Potion of Neutralize Poison', 'Potion of Remove Disease', 'Potion of Remove Paralysis', 'Potion of Shrinking', 'Potion of Stone to Flesh'];
	$potqty = count($t_potions);
	$t_count = 0;
}
